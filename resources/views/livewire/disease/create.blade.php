<div>
    ...
    <div class="block block-rounded">
        ...
        <div class="block-header">
            <h3 class="block-title d-block">Register New Disease <small>All Fields Are Required</small></h3>
        </div>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="mb-3">
                            ...
                            <small id="helpId" class="text-muted text-capitalize">write full name of the Disease</small>
                            @error('name')
