                    ...
                    <div class="block-content block-content-full">
                        <div class="row">
                            <div class="col-md-3 mb-4">
                                <img class="d-block m-auto img-thumbnail" src="{{ asset('dashboard/assets/download_1.jpeg') }}" width="150px" height="auto" alt="">
                            </div>
                            <div class="col-md-9">
                                <ol class="pl-3">
                                    <li class="block-title text-light">Your Photo Should be taken using a good camera</li>
                                    <li class="block-title text-light">Your Photo Must be Clear</li>
                                    <li class="block-title text-light">using phone is recomened to make our AI work effiecntly</li>
                                </ol>
                            </div>
                            ...
                            <div class="file-upload">
                                ...
                                <div class="file-upload-content">
                                    ...
                                    <div class="image-title-wrap">
                                      <button type="button" onclick="removeUpload()" class="remove-image">Remove <span class="image-title"><i class="si si-close"></i></span></button>
                                    </div>
                                </div>
                            </div>
